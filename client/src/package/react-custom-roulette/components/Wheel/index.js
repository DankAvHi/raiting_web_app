...
export var Wheel = function (_a) {
     ...
     var _r = useState(__spreadArray([], data)),
          wheelData = _r[0],
          setWheelData = _r[1];
     var _s = useState(0),
          startRotationDegrees = _s[0],
          setStartRotationDegrees = _s[1];
     var _t = useState(0),
          finalRotationDegrees = _t[0],
          setFinalRotationDegrees = _t[1];
     var _u = useState(false),
          hasStartedSpinning = _u[0],
          setHasStartedSpinning = _u[1];
     var _v = useState(false),
          hasStoppedSpinning = _v[0],
          setHasStoppedSpinning = _v[1];
     var _w = useState(false),
          isCurrentlySpinning = _w[0],
          setIsCurrentlySpinning = _w[1];
     var _x = useState(false),
          isDataUpdated = _x[0],
          setIsDataUpdated = _x[1];
          ...
          function () {
               ...
               for (var i = 0; i < dataLength; i++) {
                    wheelDataAux[i] = __assign(__assign({}, data[i]), {
                         style: {
                              backgroundColor:
                                   ((_a = data[i].style) === null || _a === void 0 ? void 0 : _a.backgroundColor) ||
                                   backgroundColors[i % backgroundColors.length],
                              textColor:
                                   ((_b = data[i].style) === null || _b === void 0 ? void 0 : _b.textColor) ||
