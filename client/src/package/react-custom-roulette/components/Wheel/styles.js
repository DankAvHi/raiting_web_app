...
export var RouletteContainer = styled.div(
     templateObject_1 ||
...
export var RotationContainer = styled.div(
     templateObject_2 ||
     ...
     function (_a) {
          var startSpinningTime = _a.startSpinningTime,
               continueSpinningTime = _a.continueSpinningTime;
     ...
     function (props) {
          return props.startRotationDegrees + 360;
     },
     function (props) {
          return props.startRotationDegrees;
     },
...
export var RouletteSelectorImage = styled(NonDraggableImage)(
     templateObject_3 ||
